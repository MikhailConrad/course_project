...
public class MobileDevicesController {
    ...
    @Autowired
    public MobileDevicesController (CommentService commentService) {
        this.commentService = commentService;
    }

    @GetMapping("/mobile-devices")
    public String showMobileDevicesTemplate(Model model){

        Map<Product, List<Comment>> commentsForMobileDevices =
                commentService.getCommentsForCategory("Мобильные устройства");
